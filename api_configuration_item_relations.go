...
func (r ApiGetCisIdCiRelationsRequest) XXurrentLanguage(xXurrentLanguage string) ApiGetCisIdCiRelationsRequest {
	r.xXurrentLanguage = &xXurrentLanguage
	return r
}

// Page size (max 100). See Pagination docs.
func (r ApiGetCisIdCiRelationsRequest) PerPage(perPage int32) ApiGetCisIdCiRelationsRequest {
	r.perPage = &perPage
	return r
}

// Cursor for next page (from Link rel&#x3D;next).
func (r ApiGetCisIdCiRelationsRequest) SearchAfter(searchAfter string) ApiGetCisIdCiRelationsRequest {
	r.searchAfter = &searchAfter
	return r
}

// Cursor for previous page (from Link rel&#x3D;prev).
func (r ApiGetCisIdCiRelationsRequest) SearchBefore(searchBefore string) ApiGetCisIdCiRelationsRequest {
	r.searchBefore = &searchBefore
	return r
}

// Comma-separated fields for collections (field selection).
func (r ApiGetCisIdCiRelationsRequest) Fields(fields string) ApiGetCisIdCiRelationsRequest {
	r.fields = &fields
	return r
}

// Sort fields, comma-separated; prefix with - for descending. See Ordering docs.
func (r ApiGetCisIdCiRelationsRequest) Sort(sort string) ApiGetCisIdCiRelationsRequest {
	r.sort = &sort
	return r
}

// Predefined filter name (alternative to path /state). See Filtering docs.
func (r ApiGetCisIdCiRelationsRequest) State(state string) ApiGetCisIdCiRelationsRequest {
	r.state = &state
	return r
}
...
// Override response language for enums/errors (e.g. nl, fr). See API introduction.
func (r ApiGetCisIdUsersRequest) XXurrentLanguage(xXurrentLanguage string) ApiGetCisIdUsersRequest {
	r.xXurrentLanguage = &xXurrentLanguage
	return r
}

// Page size (max 100). See Pagination docs.
func (r ApiGetCisIdUsersRequest) PerPage(perPage int32) ApiGetCisIdUsersRequest {
	r.perPage = &perPage
	return r
}

// Cursor for next page (from Link rel&#x3D;next).
func (r ApiGetCisIdUsersRequest) SearchAfter(searchAfter string) ApiGetCisIdUsersRequest {
	r.searchAfter = &searchAfter
	return r
}

// Cursor for previous page (from Link rel&#x3D;prev).
func (r ApiGetCisIdUsersRequest) SearchBefore(searchBefore string) ApiGetCisIdUsersRequest {
	r.searchBefore = &searchBefore
	return r
}

// Comma-separated fields for collections (field selection).
func (r ApiGetCisIdUsersRequest) Fields(fields string) ApiGetCisIdUsersRequest {
	r.fields = &fields
	return r
}

// Sort fields, comma-separated; prefix with - for descending. See Ordering docs.
func (r ApiGetCisIdUsersRequest) Sort(sort string) ApiGetCisIdUsersRequest {
	r.sort = &sort
	return r
}

// Predefined filter name (alternative to path /state). See Filtering docs.
func (r ApiGetCisIdUsersRequest) State(state string) ApiGetCisIdUsersRequest {
	r.state = &state
	return r
}
