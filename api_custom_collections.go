...
func (r ApiGetCustomCollectionElementsRequest) XXurrentLanguage(xXurrentLanguage string) ApiGetCustomCollectionElementsRequest {
	r.xXurrentLanguage = &xXurrentLanguage
	return r
}

// Page size (max 100). See Pagination docs.
func (r ApiGetCustomCollectionElementsRequest) PerPage(perPage int32) ApiGetCustomCollectionElementsRequest {
	r.perPage = &perPage
	return r
}

// Cursor for next page (from Link rel&#x3D;next).
func (r ApiGetCustomCollectionElementsRequest) SearchAfter(searchAfter string) ApiGetCustomCollectionElementsRequest {
	r.searchAfter = &searchAfter
	return r
}

// Cursor for previous page (from Link rel&#x3D;prev).
func (r ApiGetCustomCollectionElementsRequest) SearchBefore(searchBefore string) ApiGetCustomCollectionElementsRequest {
	r.searchBefore = &searchBefore
	return r
}

// Comma-separated fields for collections (field selection).
func (r ApiGetCustomCollectionElementsRequest) Fields(fields string) ApiGetCustomCollectionElementsRequest {
	r.fields = &fields
	return r
}

// Sort fields, comma-separated; prefix with - for descending. See Ordering docs.
func (r ApiGetCustomCollectionElementsRequest) Sort(sort string) ApiGetCustomCollectionElementsRequest {
	r.sort = &sort
	return r
}

// Predefined filter name (alternative to path /state). See Filtering docs.
func (r ApiGetCustomCollectionElementsRequest) State(state string) ApiGetCustomCollectionElementsRequest {
	r.state = &state
	return r
}
...
// Override response language for enums/errors (e.g. nl, fr). See API introduction.
func (r ApiGetCustomCollectionElementsIdRequest) XXurrentLanguage(xXurrentLanguage string) ApiGetCustomCollectionElementsIdRequest {
	r.xXurrentLanguage = &xXurrentLanguage
	return r
}

// Conditional GET; returns 304 Not Modified when unchanged.
func (r ApiGetCustomCollectionElementsIdRequest) IfNoneMatch(ifNoneMatch string) ApiGetCustomCollectionElementsIdRequest {
...
// Override response language for enums/errors (e.g. nl, fr). See API introduction.
func (r ApiGetCustomCollectionsRequest) XXurrentLanguage(xXurrentLanguage string) ApiGetCustomCollectionsRequest {
	r.xXurrentLanguage = &xXurrentLanguage
	return r
}

// Page size (max 100). See Pagination docs.
func (r ApiGetCustomCollectionsRequest) PerPage(perPage int32) ApiGetCustomCollectionsRequest {
	r.perPage = &perPage
	return r
}

// Cursor for next page (from Link rel&#x3D;next).
func (r ApiGetCustomCollectionsRequest) SearchAfter(searchAfter string) ApiGetCustomCollectionsRequest {
	r.searchAfter = &searchAfter
	return r
}

// Cursor for previous page (from Link rel&#x3D;prev).
func (r ApiGetCustomCollectionsRequest) SearchBefore(searchBefore string) ApiGetCustomCollectionsRequest {
	r.searchBefore = &searchBefore
	return r
}

// Comma-separated fields for collections (field selection).
func (r ApiGetCustomCollectionsRequest) Fields(fields string) ApiGetCustomCollectionsRequest {
	r.fields = &fields
	return r
}

// Sort fields, comma-separated; prefix with - for descending. See Ordering docs.
func (r ApiGetCustomCollectionsRequest) Sort(sort string) ApiGetCustomCollectionsRequest {
	r.sort = &sort
	return r
}

// Predefined filter name (alternative to path /state). See Filtering docs.
func (r ApiGetCustomCollectionsRequest) State(state string) ApiGetCustomCollectionsRequest {
	r.state = &state
	return r
}
...
// Override response language for enums/errors (e.g. nl, fr). See API introduction.
func (r ApiGetCustomCollectionsIdRequest) XXurrentLanguage(xXurrentLanguage string) ApiGetCustomCollectionsIdRequest {
	r.xXurrentLanguage = &xXurrentLanguage
	return r
}

// Conditional GET; returns 304 Not Modified when unchanged.
func (r ApiGetCustomCollectionsIdRequest) IfNoneMatch(ifNoneMatch string) ApiGetCustomCollectionsIdRequest {
	r.ifNoneMatch = &ifNoneMatch
	return r
}
