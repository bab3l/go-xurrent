...
// APIClient manages communication with the Xurrent REST API API v1.0.0
...
type APIClient struct {
	...
	AutomationRulesAPI *AutomationRulesAPIService
	...
	ServiceOfferingsAPI *ServiceOfferingsAPIService
