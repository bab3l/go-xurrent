...
// Class50AccountAPIService Class50AccountAPI service
type Class50AccountAPIService service

type ApiV1AccountGetRequest struct {
	ctx           context.Context
	ApiService    *Class50AccountAPIService
...
*/
func (a *Class50AccountAPIService) V1AccountGet(ctx context.Context) ApiV1AccountGetRequest {
	return ApiV1AccountGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *Class50AccountAPIService) V1AccountGetExecute(r ApiV1AccountGetRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class50AccountAPIService.V1AccountGet")
	if err != nil {
