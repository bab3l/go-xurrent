...
func (r ApiGetAttachmentsStorageRequest) XXurrentLanguage(xXurrentLanguage string) ApiGetAttachmentsStorageRequest {
	r.xXurrentLanguage = &xXurrentLanguage
	return r
}

// Conditional GET; returns 304 Not Modified when unchanged.
func (r ApiGetAttachmentsStorageRequest) IfNoneMatch(ifNoneMatch string) ApiGetAttachmentsStorageRequest {
...
// Override response language for enums/errors (e.g. nl, fr). See API introduction.
func (r ApiGetAttachmentsUploadRequest) XXurrentLanguage(xXurrentLanguage string) ApiGetAttachmentsUploadRequest {
	r.xXurrentLanguage = &xXurrentLanguage
	return r
}

// Conditional GET; returns 304 Not Modified when unchanged.
func (r ApiGetAttachmentsUploadRequest) IfNoneMatch(ifNoneMatch string) ApiGetAttachmentsUploadRequest {
	r.ifNoneMatch = &ifNoneMatch
	return r
}
