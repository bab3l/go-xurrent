...
// Class19ReservationsAPIService Class19ReservationsAPI service
type Class19ReservationsAPIService service

type ApiV1GetRequest struct {
	ctx        context.Context
	ApiService *Class19ReservationsAPIService
}
...
*/
func (a *Class19ReservationsAPIService) V1Get(ctx context.Context) ApiV1GetRequest {
	return ApiV1GetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *Class19ReservationsAPIService) V1GetExecute(r ApiV1GetRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class19ReservationsAPIService.V1Get")
	if err != nil {
...
*/
func (a *Class19ReservationsAPIService) V1RequestsPost(ctx context.Context) ApiV1RequestsPostRequest {
	return ApiV1RequestsPostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *Class19ReservationsAPIService) V1RequestsPostExecute(r ApiV1RequestsPostRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class19ReservationsAPIService.V1RequestsPost")
	if err != nil {
