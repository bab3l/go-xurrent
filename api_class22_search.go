...
// Class22SearchAPIService Class22SearchAPI service
type Class22SearchAPIService service

type ApiV1RequestsGetRequest struct {
	ctx           context.Context
	ApiService    *Class22SearchAPIService
...
*/
func (a *Class22SearchAPIService) V1RequestsGet(ctx context.Context) ApiV1RequestsGetRequest {
	return ApiV1RequestsGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *Class22SearchAPIService) V1RequestsGetExecute(r ApiV1RequestsGetRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class22SearchAPIService.V1RequestsGet")
	if err != nil {
...
*/
func (a *Class22SearchAPIService) V1SearchGet(ctx context.Context) ApiV1SearchGetRequest {
	return ApiV1SearchGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *Class22SearchAPIService) V1SearchGetExecute(r ApiV1SearchGetRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodGet
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class22SearchAPIService.V1SearchGet")
	if err != nil {
