...
// Class0EventsAPIService Class0EventsAPI service
type Class0EventsAPIService service

type ApiV1EventsPostRequest struct {
	ctx           context.Context
	ApiService    *Class0EventsAPIService
...
*/
func (a *Class0EventsAPIService) V1EventsPost(ctx context.Context) ApiV1EventsPostRequest {
	return ApiV1EventsPostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *Class0EventsAPIService) V1EventsPostExecute(r ApiV1EventsPostRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class0EventsAPIService.V1EventsPost")
	if err != nil {
