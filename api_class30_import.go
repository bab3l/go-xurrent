...
// Class30ImportAPIService Class30ImportAPI service
type Class30ImportAPIService service

type ApiV1ImportPostRequest struct {
	ctx           context.Context
	ApiService    *Class30ImportAPIService
...
*/
func (a *Class30ImportAPIService) V1ImportPost(ctx context.Context) ApiV1ImportPostRequest {
	return ApiV1ImportPostRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *Class30ImportAPIService) V1ImportPostExecute(r ApiV1ImportPostRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class30ImportAPIService.V1ImportPost")
	if err != nil {
