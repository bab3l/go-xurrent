...
func (r ApiGetServiceOfferingsRequest) XXurrentLanguage(xXurrentLanguage string) ApiGetServiceOfferingsRequest {
	r.xXurrentLanguage = &xXurrentLanguage
	return r
}

// Page size (max 100). See Pagination docs.
func (r ApiGetServiceOfferingsRequest) PerPage(perPage int32) ApiGetServiceOfferingsRequest {
	r.perPage = &perPage
	return r
}

// Cursor for next page (from Link rel&#x3D;next).
func (r ApiGetServiceOfferingsRequest) SearchAfter(searchAfter string) ApiGetServiceOfferingsRequest {
	r.searchAfter = &searchAfter
	return r
}

// Cursor for previous page (from Link rel&#x3D;prev).
func (r ApiGetServiceOfferingsRequest) SearchBefore(searchBefore string) ApiGetServiceOfferingsRequest {
	r.searchBefore = &searchBefore
	return r
}

// Comma-separated fields for collections (field selection).
func (r ApiGetServiceOfferingsRequest) Fields(fields string) ApiGetServiceOfferingsRequest {
	r.fields = &fields
	return r
}

// Sort fields, comma-separated; prefix with - for descending. See Ordering docs.
func (r ApiGetServiceOfferingsRequest) Sort(sort string) ApiGetServiceOfferingsRequest {
	r.sort = &sort
	return r
}

// Predefined filter name (alternative to path /state). See Filtering docs.
func (r ApiGetServiceOfferingsRequest) State(state string) ApiGetServiceOfferingsRequest {
	r.state = &state
	return r
}
...
// Override response language for enums/errors (e.g. nl, fr). See API introduction.
func (r ApiGetServiceOfferingsIdRequest) XXurrentLanguage(xXurrentLanguage string) ApiGetServiceOfferingsIdRequest {
	r.xXurrentLanguage = &xXurrentLanguage
	return r
}

// Conditional GET; returns 304 Not Modified when unchanged.
func (r ApiGetServiceOfferingsIdRequest) IfNoneMatch(ifNoneMatch string) ApiGetServiceOfferingsIdRequest {
...
// Override response language for enums/errors (e.g. nl, fr). See API introduction.
func (r ApiGetServiceOfferingsIdAuditRequest) XXurrentLanguage(xXurrentLanguage string) ApiGetServiceOfferingsIdAuditRequest {
	r.xXurrentLanguage = &xXurrentLanguage
	return r
}

// Page size (max 100). See Pagination docs.
func (r ApiGetServiceOfferingsIdAuditRequest) PerPage(perPage int32) ApiGetServiceOfferingsIdAuditRequest {
	r.perPage = &perPage
	return r
}

// Cursor for next page (from Link rel&#x3D;next).
func (r ApiGetServiceOfferingsIdAuditRequest) SearchAfter(searchAfter string) ApiGetServiceOfferingsIdAuditRequest {
	r.searchAfter = &searchAfter
	return r
}

// Cursor for previous page (from Link rel&#x3D;prev).
func (r ApiGetServiceOfferingsIdAuditRequest) SearchBefore(searchBefore string) ApiGetServiceOfferingsIdAuditRequest {
	r.searchBefore = &searchBefore
	return r
}

// Comma-separated fields for collections (field selection).
func (r ApiGetServiceOfferingsIdAuditRequest) Fields(fields string) ApiGetServiceOfferingsIdAuditRequest {
	r.fields = &fields
	return r
}

// Sort fields, comma-separated; prefix with - for descending. See Ordering docs.
func (r ApiGetServiceOfferingsIdAuditRequest) Sort(sort string) ApiGetServiceOfferingsIdAuditRequest {
	r.sort = &sort
	return r
}

// Predefined filter name (alternative to path /state). See Filtering docs.
func (r ApiGetServiceOfferingsIdAuditRequest) State(state string) ApiGetServiceOfferingsIdAuditRequest {
	r.state = &state
	return r
}
